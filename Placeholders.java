 ...
 * Placeholders for testing the seating assignment system.
 */
...
/**
* Table
* This class is for the Table, possessing table data such as the capacity, name, etc.
...
class Table {
    ...
    */
    public Table(int capacity, String tableName) {
        ...
        //The list of students in the table, to be operated on using addStudent, isEmpty, and the getStudentList getter.
    ...
    * @return (Boolean) - true if the student has been added, false if there is no capacity.
    */
    public boolean addStudent(Student student) {
        
        //Iterate through the studdentList, checking if there is capacity (if studentList[i] is empty, meaning there is a slot)
    ...
    */
    public boolean isEmpty() {
        ...
        //Iterate through the studentList to check if any element is not empty (not null)
        for (int i = 0; i < studentList.length; i++) {
            if (studentList[i] != null) {
                empty = false;
                break;
    ...
    * int toString
    * Table representer
    * @return Name " " Capacity (String) representation of the table in the format Name " " Capacity (e.g. Name 3)
    */
...
/**
* Student
* This class is for the Student, possessing Student data such as name, grade, etc.
...
class Student {
    ...
    * String toString
    * Student representer
    * @return Name Friends Preferences (String) - representation of the Student in the format Name Friends Capacity (e.g. Name: X,Y,Z)
    */
    public String toString() {
